// Lucide icon SVG paths — inline, offline-safe, no dependency
const STROKE = 'stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"';

function icon(paths, size = 20) {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" ${STROKE}>${paths}</svg>`;
}
